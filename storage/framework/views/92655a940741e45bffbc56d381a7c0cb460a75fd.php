...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row pt-1">
                                ...
                                <input type="file" class="form-control-file" id="filename" value="<?php echo e(old('filename')); ?>" name="filename">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row pt-3">
                                ...
                                <input type="file" class="form-control-file" id="image" value="<?php echo e(old('image')); ?>" name="image">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="pt-3 row">
            <div class="offset-1 pl-5">
                <button class="btn btn-primary" style="width: 125px" onclick="window.location='<?php echo e(url("/media/show/".$user->id)); ?>'">Go Back</button>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Imad\Projects\2019\New\burnz\resources\views/private/media/create.blade.php ENDPATH**/ ?>